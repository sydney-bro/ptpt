...
describe('ptpt_zk_test', function () {

    const eidB = 30109
    let owner: Address
    let contractName = "ptpt_zk"
    let contractAddress = "0x1925505972D63b69212B6021C2dBe6bA794222F3"
    ...
    it('should send a token from A address to B address via each OFT', async function () {
        ...
        const contract = new ethers.Contract(contractAddress,pointlessTokenZkABI,signer);
        ...
        await contract.send(sendParam, [nativeFee, 0], owner, { value: nativeFee })
